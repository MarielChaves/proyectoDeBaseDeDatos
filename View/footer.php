<div class="row">
    <div class="col-lg-12" id="contFooter">
        <hr/>
        <div>
            <div>
                    ...
                    <div>
                        <table id="tablaFooter">
                            <tr>
                                ...
                                <td id="colTablaFooter"><a id="styleLinkFooter" class="linkNav" href="https://www.youtube.com">Youtube</a></td>
                                <td id="colTablaFooter"><i class="fab fa-youtube"></i></td>
                            </tr>
                        </table>
                    </div>
                </footer>
...
<script href="Assets/js/ocultarWidget.js" type="text/javascript"></script>
